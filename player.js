...
const BUB_DEATH_LEFT = 8; 
const BUB_DEATH_RIGHT = 9; 
...
function Player(x, y, map)
{
	...
	this.sprite.addAnimation(); 
	this.sprite.addKeyframe(BUB_DEATH_LEFT, [64,0,32,32]);
	this.sprite.addKeyframe(BUB_DEATH_LEFT, [64,32,32,32]);
	this.sprite.addKeyframe(BUB_DEATH_LEFT, [64,64,32,32]);

	this.sprite.addAnimation(); 
	this.sprite.addKeyframe(BUB_DEATH_RIGHT, [64,0,32,32]);
	this.sprite.addKeyframe(BUB_DEATH_RIGHT, [64,32,32,32]);
	this.sprite.addKeyframe(BUB_DEATH_RIGHT, [64,64,32,32]);
...
Player.prototype.deathanimationleft = function(){
	if (this.sprite.currentAnimation != BUB_DEATH_LEFT)  this.sprite.setAnimation(BUB_DEATH_LEFT);
}
Player.prototype.deathanimationright = function(){
	if(this.sprite.currentAnimation != BUB_DEATH_RIGHT) this.sprite.setAnimation(BUB_DEATH_RIGHT);
}


Player.prototype.update = function(deltaTime)
{
	if(this.sprite.currentAnimation != BUB_DEATH_LEFT && this.sprite.currentAnimation != BUB_DEATH_RIGHT){
