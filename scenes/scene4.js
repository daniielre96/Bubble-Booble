...
function Scene4(){
    ...
    this.player = new Player(100, 240, this.map);
...
Scene4.prototype.checkActualLevel = function(){
    ...
    if(keyboard[53] || ((!this.arañaragedactive && !this.robotragedactive && ((this.timerToPickUpFruit) > 10000))) || (!this.arañaragedactive && !this.robotragedactive && !this.fruitactive && !this.papaactive)) return 9;
